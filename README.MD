...
Legend: ✅ Implemented · 🚧 In progress · ❌ Not implemented · ⛔ Not supported
...
> Basic navigation support means: one-step forward, one-step back, query can-go-forward, query can-go-back.
